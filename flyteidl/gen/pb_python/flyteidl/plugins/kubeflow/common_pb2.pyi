...
class RunPolicy(_message.Message):
    __slots__ = ["clean_pod_policy", "ttl_seconds_after_finished", "active_deadline_seconds", "backoff_limit", "scheduling_policy"]
    ...
    def __init__(self, clean_pod_policy: _Optional[_Union[CleanPodPolicy, str]] = ..., ttl_seconds_after_finished: _Optional[int] = ..., active_deadline_seconds: _Optional[int] = ..., backoff_limit: _Optional[int] = ..., scheduling_policy: _Optional[_Union[SchedulingPolicy, _Mapping]] = ...) -> None: ...
